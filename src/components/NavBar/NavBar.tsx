...
export default function NavBar() {
  ...
  return (
    <nav className=" bg-white dark:bg-dark-06 fixed w-full 2xl:px-[162px] lg:px-[80px] md:px-10 px-4 2xl:py-[30px] lg:py-6 md:py-6 py-5 flex justify-between items-center ">
