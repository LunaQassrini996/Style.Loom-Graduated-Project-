  ...
  return (
    <section className=" 2xl:px-[162px] lg:px-[80px] md:px-10 px-4">
        ...
        <div className="flex flex-col justify-start items-start gap-4">
            <h2 className="text-dark-06 font-roboto font-medium 2xl:text-[58px] lg:text-5xl md:text-[38px] text-[38px] relative z-20 ">ELEVATE YOUR WARDROBE</h2>
            <p className="text-dark-12 font-normal font-roboto 2xl:text-lg lg:text-base md:text-sm text-sm relative z-20 2xl:w-[84%] lg:w-full md:w-full w-full ">Don't miss out – experience the epitome of fashion by clicking 'Buy Now' and embrace a world of chic elegance delivered to your doorstep. Your style journey begins here.</p>
        </div>
