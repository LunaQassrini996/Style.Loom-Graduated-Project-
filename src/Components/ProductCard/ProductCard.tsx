...
export default function ProductCard({id,image,type,title,fit,price}:{id:number,image:string,type:string,title:string,fit:string,price:number}) {
  ...
  return (
    <div  className='2xl:w-full md:w-full hover:bg-[#2d2d2d] ease-in-out duration-150 2xl:h-[639px] lg:h-[491px] h-[474px] lg: 2xl:p-[30px] xl:border-r-2 lg:border-r-[1.5px]  border-r border-dashed border-[#262626] p-5 lg:pb-[30px] flex flex-col 2xl:gap-[30px] p- lg:gap-6 gap-5 '>
        ...
        <div className='w-full flex justify-between items-center'>
            ...
            <div className='max-lg:hidden'><ShopNowBtn  btnTitle='Shop Now' path={`/products/${id}`} showIcon={true} /></div>
        </div>
