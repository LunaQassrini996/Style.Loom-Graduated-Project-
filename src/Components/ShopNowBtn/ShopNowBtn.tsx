...
export default function ShopNowBtn({ path, btnTitle, showIcon, width, cart }: props) {
    ...
    return (
        <button onClick={() => navigate(path)} className={`cursor-pointer whitespace-nowrap relative ${width} rounded-[12px] border-2 border-dashed border-[#404040] 2xl:py-[18px] 2xl:px-6 py-3.5 px-5 bg-[#1F1F1F] text-white h-fit`}>
