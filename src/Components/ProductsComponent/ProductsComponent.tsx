...
const ProductsComponent: React.FC = () => {
    ...
    return (
        <div className="w-full justify-self-center max-lg:w-[720px] max-md:w-[358px] ">
            <div className=" w-full max-md:w-[358px] 2xl:rounded-t-[20px] lg:rounded-t-2xl rounded-t-[14px] xl:border-2 xl:border-b-0 lg:border-[1.5px] lg:border-b-0  border border-b-0 border-dashed border-[#262626] ">
            ...
            <div className="w-[1596px] max-w-full mx-auto  xl:border-2 xl:border-r-0 lg:border-[1.5px] lg:border-r-0  border border-r-0 border-dashed border-[#262626]">
                <div
                    className="2xl:h-[1278px]   lg:h-[982px] h-[1422px] group relative  bg-black shadow-md overflow-y-auto overflow-x-hidden cursor-grab transition-shadow custom-scrollbar "
                    ref={scrollRef}
                    onMouseDown={onMouseDown}
                    style={{ WebkitOverflowScrolling: "touch" }}
                >
                    <div className="grid  xl:divide-y-2 lg:divide-y-[1.5px]   divide-y-[1px] divide-dashed divide-[#262626]  lg:grid-cols-3 md:grid-cols-2 grid-cols-1 2xl:auto-rows-[639px] lg:auto-rows-[491px] auto-rows-[474px]  ">
                        {cards}
                    </div>
                </div>
