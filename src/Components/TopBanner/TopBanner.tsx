...
<<<<<<< HEAD
        <div className='overflow-hidden  w-full flex flex-col 2xl:p-20 lg:p-[60px] py-[30px] px-5 2xl:gap-[50px] lg:gap-10 gap-[30px]  relative' >
            <img src={`/images/abstractDesign${imgNumber}.png`} className='z-0 absolute xl:right-0 top-[50%] translate-y-[-50%] h-full aspect-square -right-20  max-lg:hidden' />
=======
...
>>>>>>> 67b7e98a8d8cf0e2782f5197ff402d1fa32523b1
