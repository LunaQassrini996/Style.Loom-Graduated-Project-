...
export default function Hero() {
  ...
  return (
    <>
    <div className='2xl:max-w-[1596px] 2xl:rounded-[20px] lg:rounded-2xl rounded-[14px] border-2 border-dashed border-gray-600 dark:border-dark-15  justify-self-center w-full overflow-hidden'>
      ...
      <div className="w-full  lg:flex  block   relative bg-white dark:bg-dark-06  ">
        ...
        <div className="lg:w-[50%] h-full  2xl:p-20 lg:p-[60px] pt-[60px] pb-5 px-5 lg:border-r-2 lg:border-b-0 border-b-2 border-dashed border-gray-600 dark:border-dark-15  flex flex-col gap-[30px]  ">
        ...
        <div className="lg:w-[50%] divide-x-2  divide-dashed divide-gray-600 dark:divide-dark-15 h-full grid grid-cols-2">
          <div className="max-h-[219px] flex justify-center flex-col 2xl:gap-4 lg:gap-3 gap-2.5 2xl:pt-[94px] lg:px-[50px] lg:pb-[50px] lg:pt-[74px] p-[30px] border-b-2  border-dashed border-gray-600 dark:border-dark-15  ">
            ...
            <p className="text-[#81807E] 2xl:text-lg lg:text-base text-sm leading-[150%] ">Fashion Products</p>
          </div>
          <div className="max-h-[219px] flex justify-center flex-col 2xl:gap-4 lg:gap-3 gap-2.5 2xl:pt-[94px] lg:px-[50px] lg:pb-[50px] lg:pt-[74px] p-[30px] border-b-2  border-dashed border-gray-600 dark:border-dark-15 ">
            ...
            <p className="text-[#81807E] 2xl:text-lg lg:text-base text-sm leading-[150%] ">New arrivals every month.</p>
          </div>
          <div className="max-h-[219px] flex justify-center flex-col 2xl:gap-4 lg:gap-3 gap-2.5 2xl:py-[70px] lg:p-[50px]  p-[30px] border-dashed border-dark-15 ">
            ...
            <p className="text-[#81807E] 2xl:text-lg lg:text-base text-sm leading-[150%] ">OFF on select items.</p>
          </div>
          <div className="max-h-[219px] flex justify-center flex-col 2xl:gap-4 lg:gap-3 gap-2.5 2xl:py-[70px] lg:p-[50px]   p-[30px] ">
            ...
            <p className="text-[#81807E] 2xl:text-lg lg:text-base text-sm leading-[150%] ">Customer Satisfaction Rate</p>
          </div>
        </div>
      </div>
    </div>
